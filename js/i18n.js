...
const AMANI_I18N = {
  en: {
    ...
    'mission.card_desc': 'To empower African refugee, immigrant, and newcomer youth and families through education, language access, after-school enrichment, and holistic guidance — fostering self-reliance and lifelong belonging.',
    ...
    'programs.lead': 'From joyful cultural festivals to targeted after-school academic spaces, our programs meet families where they are with authenticity and care.',
    'programs.bisakana_tag': 'SIGNATURE EXPERIENCE',
    'programs.bisakana_sub': '"Play and Have Fun" in Lingala',
    'programs.bisakana_desc': 'Bisakana Day is our signature cultural celebration that brings African newcomer families, neighbors, and community partners together. Through traditional music, dance, authentic food, games, and storytelling, children experience uninhibited joy and cultural pride while parents access critical community resources in a festive, pressure-free environment.',
    ...
    'programs.connect_desc': 'A trusted resource hub connecting families with bilingual advocacy, school system enrollment, healthcare referrals, and community partnerships.',
    'programs.sauti_title': 'SAUTI SAFE SPACE',
    'programs.sauti_sub': '"Voice" in Swahili • Youth Literacy & Arts',
    'programs.sauti_desc': 'A nurturing after-school environment where youth build literacy skills, express themselves through creative arts, receive homework mentoring, and find their authentic voice.',
    'programs.outreach_title': 'INTERNATIONAL OUTREACH',
    'programs.outreach_sub': 'Cross-Border Solidarity & Hope',
    'programs.outreach_desc': "Extending Amani Kids' mission through grassroots educational partnerships that connect local diaspora families with vulnerable communities in Africa.",
    ...
    'programs.bisakana_check3': 'Free community resource fair, school backpack and supply distribution',
    ...
    'programs.connect_check1': 'Charlotte-Mecklenburg Schools (CMS) bilingual registration & IEP support',
    'programs.connect_check2': 'Community healthcare navigation, medical appointments & Medicaid guidance',
    'programs.connect_check3': 'Cultural mediation and native-language document translation',
    
    'programs.sauti_pill': 'YOUTH LITERACY & CREATIVE ARTS',
    'programs.sauti_headline': 'Nurturing the Next Generation of Voices.',
    'programs.sauti_badge': 'Daily After-School Mentorship',
    'programs.sauti_check1': 'After-school English literacy, homework tutoring & academic mentoring',
    'programs.sauti_check2': 'Creative writing circles, oral poetry, music and African storytelling',
    'programs.sauti_check3': 'Social-emotional support, youth peer circles & leadership development',
    ...
    'programs.outreach_check1': 'Educational material drives for under-resourced schools in DR Congo and Africa',
    'programs.outreach_check2': 'Cross-continental youth pen-pal exchanges and cultural dialogue',
    'programs.outreach_check3': 'Strengthening diaspora bonds and giving back to ancestral communities',
  ...
  fr: {
    ...
    'mission.card_desc': "Donner aux jeunes et aux familles réfugiées et immigrées de la diaspora africaine les moyens de s'épanouir par l'éducation, l'accès linguistique, le mentorat et un accompagnement holistique favorisant l'autonomie et l'appartenance.",
    ...
    'programs.lead': 'Des festivals culturels festifs aux espaces parascolaires de soutien scolaire, nos programmes rejoignent les familles avec authenticité et chaleur.',
    'programs.bisakana_tag': 'EXPÉRIENCE SIGNATURE',
    'programs.bisakana_sub': '« Jouer et s’amuser » en lingala',
    'programs.bisakana_desc': 'La Journée Bisakana est notre célébration culturelle phare qui rassemble les familles nouvellement arrivées, les voisins et les partenaires. Au son des percussions traditionnelles, des danses, des plats authentiques et des contes, les enfants vivent une joie pure pendant que les parents accèdent à des ressources utiles dans un cadre festif.',
    ...
    'programs.sauti_title': 'SAUTI SAFE SPACE',
    'programs.sauti_sub': '« La Voix » en swahili • Littératie et Arts pour la Jeunesse',
    'programs.sauti_desc': 'Un cadre bienveillant après l’école où les jeunes renforcent leur lecture, s’expriment par les arts, reçoivent de l’aide aux devoirs et trouvent leur voix.',
    'programs.outreach_title': 'SOLIDARITÉ INTERNATIONALE',
    'programs.outreach_sub': 'Liens Transfrontaliers & Espoir',
    'programs.outreach_desc': 'Étendre la mission d’Amani Kids par des initiatives éducatives reliant la diaspora de Charlotte aux communautés en Afrique.',
    ...
    'programs.bisakana_check3': 'Foire d’accès aux services publics et distribution gratuite de fournitures',
    ...
    'programs.connect_check1': 'Inscription scolaire bilingue et suivi personnalisé avec les écoles CMS',
    'programs.connect_check2': 'Accès aux soins médicaux, démarches d’assurance et orientation santé',
    'programs.connect_check3': 'Médiation interculturelle et traduction de documents officiels',
    
    'programs.sauti_pill': 'LITTÉRATIE, ARTS & EXPRESSION JEUNESSE',
    'programs.sauti_headline': 'Faire grandir les voix de la nouvelle génération.',
    'programs.sauti_badge': 'Mentorat Scolaire Quotidien',
    'programs.sauti_check1': 'Soutien scolaire quotidien, perfectionnement de l’anglais et mentorat',
    'programs.sauti_check2': 'Ateliers d’écriture, contes traditionnels, poésie orale et arts vivants',
    'programs.sauti_check3': 'Développement du leadership, confiance en soi et cercle de parole',
    
    'programs.outreach_pill': 'ALLIANCES & SOLIDARITÉ TRANSFRONTALIÈRE',
    'programs.outreach_headline': 'Relier les racines et cultiver la fraternité par-delà les frontières.',
    'programs.outreach_badge': 'Solidarité Éducative Internationale',
    'programs.outreach_check1': 'Envoi de matériel scolaire et pédagogique aux écoles vulnérables en RD Congo',
    'programs.outreach_check2': 'Échanges épistolaires et dialogue interculturel entre jeunes d’ici et d’Afrique',
    'programs.outreach_check3': 'Préservation du lien d’origine et investissement solidaire durable',
